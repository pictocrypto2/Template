...
import { I as Img, M as ModalTitle, a as ModalDescription, F as FormFieldWithIconButton, i as isMobile, j as fadeInAnimation, k as Skeleton, H as HelperLink, f as useSetIsWalletModalOpen, l as SetModalConfigCtx, u as useIsHeadlessWallet, G as GetStartedScreen, n as ModalConfigCtx, e as useIsWalletModalOpen, b as HeadlessConnectUI, o as WalletSelector, p as WalletUIStatesProvider, d as defaultWallets } from './headlessConnectUI-33f7b972.esm.js';
...
function useRainbowWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      rainbowWallet
    } = await import('./RainbowWallet-4a646d1d.esm.js');
...
function useTrustWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      trustWallet
    } = await import('./TrustWallet-1a6e1cfa.esm.js');
...
function useMetamask() {
  ...
  return useCallback(async connectOptions => {
    const {
      metamaskWallet
    } = await import('./headlessConnectUI-33f7b972.esm.js').then(function (n) { return n.r; });
...
function useCoinbaseWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      coinbaseWallet
    } = await import('./headlessConnectUI-33f7b972.esm.js').then(function (n) { return n.q; });
...
function useFrameWallet() {
  ...
  return useCallback(async connectOptions => {
    const {
      frameWallet
    } = await import('./frameWallet-53c5948b.esm.js');
...
function usePaperWallet() {
  ...
  return useCallback(async options => {
    const {
      paperWallet
    } = await import('./paperWallet-aa264535.esm.js');
...
function useWalletConnectV1() {
  ...
  return useCallback(async options => {
    const {
      walletConnectV1
    } = await import('./walletConnectV1-9373f6f0.esm.js');
...
function useWalletConnect() {
  ...
  return useCallback(async options => {
    const {
      walletConnect
    } = await import('./headlessConnectUI-33f7b972.esm.js').then(function (n) { return n.s; });
