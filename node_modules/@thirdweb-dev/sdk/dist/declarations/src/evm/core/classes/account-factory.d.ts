...
export declare class AccountFactory<TContract extends IAccountFactory> implements DetectableFeature {
     ...
     */
    createAccount: {
        (accountAdmin: string, extraData?: BytesLike | undefined): Promise<TransactionResultWithAddress>;
        prepare: (accountAdmin: string, extraData?: BytesLike | undefined) => Promise<Transaction<TransactionResultWithAddress>>;
    };
}
